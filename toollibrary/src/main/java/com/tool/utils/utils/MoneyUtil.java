...
public class MoneyUtil {
    ...
    public static String moneydiv(String valueStr, String divideStr){
        ...
        return fnum.format(value.divide(divideValue, DEFAULT_DIV_SCALE, BigDecimal.ROUND_HALF_EVEN));
    }
    ...
    public static BigDecimal moneydiv(BigDecimal value, BigDecimal divideValue){
        return value.divide(divideValue, DEFAULT_DIV_SCALE, BigDecimal.ROUND_HALF_EVEN);
    }

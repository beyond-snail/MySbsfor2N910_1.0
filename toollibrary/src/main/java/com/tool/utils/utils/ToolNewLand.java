...
//                            }
    ...
    public void printShiftRoom(final ShiftRoom printerData,final long start_time, final long end_time, final int type) {
        try {
            ...
            data.add(new PrintItemObj("实收金额："+ ((printerData.getPay_swipe() != null) ? printerData.getPay_swipe().getReal_pay_money() : "0")+"元"));
            data.add(new PrintItemObj("优惠券抵扣金额："+ ((printerData.getPay_swipe() != null) ? printerData.getPay_swipe().getCoupon_deduct() : "0")+"元"));
            data.add(new PrintItemObj("积分抵扣金额："+ ((printerData.getPay_swipe() != null) ? printerData.getPay_swipe().getIntergral_deduct() : "0")+"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("实收金额："+ ((printerData.getPay_cash() != null) ? printerData.getPay_cash().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("优惠券抵扣金额："+ ((printerData.getPay_cash() != null) ? printerData.getPay_cash().getCoupon_deduct() : "0")+"元"));
            data.add(new PrintItemObj("积分抵扣金额："+ ((printerData.getPay_cash() != null) ? printerData.getPay_cash().getIntergral_deduct()  : "0")+"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("实收金额："+ ((printerData.getPay_wx() != null) ? printerData.getPay_wx().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("优惠券抵扣金额："+ ((printerData.getPay_wx() != null) ? printerData.getPay_wx().getCoupon_deduct() : "0")+"元"));
            data.add(new PrintItemObj("积分抵扣金额："+ ((printerData.getPay_wx() != null) ? printerData.getPay_wx().getIntergral_deduct()  : "0")+"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("实收金额："+ ((printerData.getPay_aly() != null) ? printerData.getPay_aly().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("优惠券抵扣金额："+ ((printerData.getPay_aly() != null) ? printerData.getPay_aly().getCoupon_deduct() : "0")+"元"));
            data.add(new PrintItemObj("积分抵扣金额："+ ((printerData.getPay_aly() != null) ? printerData.getPay_aly().getIntergral_deduct()  : "0")+"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("实收金额："+ ((printerData.getPay_qb() != null) ? printerData.getPay_qb().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("优惠券抵扣金额："+ ((printerData.getPay_qb() != null) ? printerData.getPay_qb().getCoupon_deduct() : "0")+"元"));
            data.add(new PrintItemObj("积分抵扣金额："+ ((printerData.getPay_qb() != null) ? printerData.getPay_qb().getIntergral_deduct()  : "0")+"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("撤销金额："+ ((printerData.getPay_unswipe() != null) ? printerData.getPay_unswipe().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("撤销金额："+ ((printerData.getPay_unwx() != null) ? printerData.getPay_unwx().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("撤销金额："+ ((printerData.getPay_unaly() != null) ? printerData.getPay_unaly().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("撤销金额："+ ((printerData.getPay_unqb() != null) ? printerData.getPay_unqb().getReal_pay_money() : "0") +"元"));
            data.add(new PrintItemObj("--------------------------------"));
            ...
            data.add(new PrintItemObj("实收总金额："+ ((printerData.getTotal() != null) ? printerData.getTotal().getReal_pay_money() : "0")+"元"));
            data.add(new PrintItemObj("交易撤销总金额："+ ((printerData.getTotal() != null) ? printerData.getTotal().getReal_undo_money() : "0")+"元"));
            data.add(new PrintItemObj("优惠券抵扣总金额："+ ((printerData.getTotal() != null) ? printerData.getTotal().getCoupon_deduct() : "0")+"元"));
            data.add(new PrintItemObj("积分抵扣总金额："+ ((printerData.getTotal() != null) ? printerData.getTotal().getIntergral_deduct() : "0") +"元"));
            data.add(new PrintItemObj("\r"));
            data.add(new PrintItemObj("\r"));

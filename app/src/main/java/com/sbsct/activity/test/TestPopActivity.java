package com.sbsct.activity.test;
...
import com.views.MenuPopWindow.CustomPopWindow;
import com.views.MenuPopWindow.MyPopAdapter;
import com.sbsct.R;

import java.util.ArrayList;
import java.util.List;

public class TestPopActivity extends Activity implements View.OnClickListener {
...
//        recyclerView.setLayoutManager(manager);
        MyPopAdapter adapter = new MyPopAdapter(mockData(), this);
    ...
    private void handleLogic(View contentView){
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TestPopActivity.this,showContent,Toast.LENGTH_SHORT).show();
            }
        };
